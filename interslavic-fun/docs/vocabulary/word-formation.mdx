...
* **`k/c`** \> **`č`** (e.g. _`ruka`_ \> _`ručny`_)
* **`g`** \> **`ž`** (e.g. _`kniga`_ \> _`knižka`_)
* **`h`** \> **`š`** (e.g. _`muha`_ \> _`mušji`_)
...
* To derive an adjective that expresses a possibility (cf. English _\-`able/-ible`_), the endings **\-`omy`** (**\-`emy`, -`imy`**) or **\-`livy`** can be attached to the present tense stem:  
