...
import DeclensionOfFeminineNouns from '../partials/_declensionOfFeminineNouns.mdx';
import AthematicDeclension from '../partials/_athematicDeclension.mdx';
...
*   An optional fourth („athematic”) declension is discussed [below](#athematic_declension).
...
*   Some nouns ending in a hard consonant have a soft consonant in scientific orthography, f.ex. _`gosť`_ „guest”, _`lěkaŕ`_ „doctor, physician”. They can follow both the hard and the soft declension pattern: gen.pl. _`gostov`_ or _`gostev`_.
...
*   masculine nouns on **\-`enj`**, a tiny group including f.ex. _`kamenj`_ „stone” and _`korenj`_ „root”
*   neuter nouns on **\-`me`/-`men`-**, containing numerous nouns like _`ime`_ „name”, _`rame`_ „shoulder”, _`brěme`_ „burden”
*   neuter nouns on **\-`e`/-`et`-**, referring to children and young animals, f.ex. _`tele`_ „calf”, _`prase`_ „piglet”
*   neuter nouns on **\-`o`/-`es`-**, a group of only a few words, f.ex. _`nebo`_ „heaven”
*   feminine nouns on **\-`ov`**, f.ex. _`crkov`_ „church”, _`mrkov`_ „carrot”
